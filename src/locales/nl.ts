...
export const nl = {
  ...
  "tracks.subtitle":
    "Twee manieren om te steunen, één doel. Kies\u00a0een\u00a0parcours.",
  ...
  // register
  "register.overline": "Parcours A · Doneren of Lopen",
  ...
  "register.howParticipate": "Hoe wil je deelnemen?",
  "register.runOnDay": "Ik loop mee op de dag zelf",
  "register.supportAnywhere": "Ik steun vanuit om het even waar",
  ...
  "register.total": "Totaal: €{price}",
  "register.totalEmpty": "Totaal: €—",
  "register.submitRunner": "Inschrijven — €{price}",
  "register.submitSupporter": "Steunen — €{price}",
  "register.submitting": "Bezig met inschrijven...",
  "register.selectTier": "Selecteer een niveau om in te schrijven",
  "register.failedFallback":
    "Inschrijving mislukt. Probeer het opnieuw.",
  "register.networkError":
    "Kan geen verbinding maken met de inschrijvingsserver. Probeer het later opnieuw.",
  "register.errorFullName": "Volledige naam is verplicht",
  "register.errorEmail": "Een geldig e-mailadres is verplicht",
  "register.errorTshirt": "T-shirtmaat is verplicht",
  "register.errorCountry": "Land is verplicht",
  "register.errorGdpr": "AVG-toestemming is verplicht om in te schrijven",
  "register.confirmHeading": "Inschrijving bevestigd!",
  ...
  "register.confirmDonationHeading": "Voltooi je donatie van €{amount}",
  ...
  "tierCard.select": "Selecteren",

  // fundraise
  "fundraise.overline": "Parcours B · Fondsen werven en Lopen",
  ...
  "fundraise.fullName": "Volledige naam",
  ...
  "fundraise.errorFullName": "Volledige naam is verplicht",
  ...
  "confirmation.subheading":
    "Deel je pagina met vrienden en familie — {name}",
  ...
  "confirmation.afterDonation":
    "Na het voltooien van je donatie hierboven:",
  ...
  "donorWall.gateButton":
    "Ik heb gedoneerd — laat een steunbericht achter",
  ...
  "social.shareMessage":
    "Steun de fondsenwerving van {title} voor Run for Ukraine 2026! Elke euro financiert oplaadstations voor de verdedigers van Oekraïne.",
  ...
  "errors.VALIDATION_FULLNAME_REQUIRED": "Volledige naam is verplicht",
  ...
  "errors.VALIDATION_DONOR_NAME_LENGTH":
    "Naam moet 2-50 tekens bevatten",
  "errors.VALIDATION_DONOR_MESSAGE_LENGTH":
    "Bericht moet 5-200 tekens bevatten",
  "errors.VALIDATION_SLUG_REQUIRED":
    "Fondsenwervings-ID is verplicht",
  "errors.VALIDATION_SLUG_NOT_FOUND":
    "Fondsenwervingspagina niet gevonden",
