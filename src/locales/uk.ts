...
export const uk = {
  ...
  "hero.title": "Run for Ukraine: Благодійний забіг на честь 35 років Незалежності",
  "hero.description":
    "Приєднуйся до нас у Брюсселі 23 серпня, у День Державного Прапора України та напередодні 35-ї річниці Незалежності України, на Run for Ukraine, благодійний забіг, відкритий для всіх, незалежно від віку чи рівня підготовки. Цим забігом ми збираємо кошти на підтримку фонду Hurkit для закупівлі портативних електростанцій, які забезпечують електроенергією підрозділи ППО України там, де вона найбільше потрібна.",
  "hero.readMore": "Детальніше про подію",
  "hero.whyHeading": "Навіщо брати участь і донатити?",
  "hero.whyBody":
    "Портативні електростанції, які ми фінансуємо, допомагають підрозділам ППО України працювати там, де надійна електроенергія найважче доступна, захищаючи небо і людей під ним. Ініціатива підтримується фондом Hurkit, українською NGO, яка безпосередньо працює з підрозділами ППО на місцях. Біжи в солідарності і святкуй разом з нами: після забігу приєднуйся до нас на площі Beguinage, де буде українська кухня, святковий концерт і традиційний ярмарок на честь Дня Незалежності України.",
  "hero.scheduleHeading": "Деталі заходу",
  "hero.scheduleIntro":
    "Відкрито для всіх. Обери один з двох маршрутів: 5 км у спокійному темпі (початковий рівень) або 8 км у швидшому темпі (середній рівень). Обидва маршрути фінішують на площі Beguinage.",
  "hero.scheduleGathering":
    "10:00. Збір учасників на Place du Luxembourg, реєстрація та отримання стартових номерів",
  "hero.scheduleFlag":
    "11:00. Церемонія розгортання Державного Прапора України",
  "hero.scheduleRun": "11:30. Старт забігу",
  "hero.scheduleAfter":
    "Після забігу. Святкування на площі Beguinage з українською їжею, музикою та ярмарком",
  "hero.scheduleOrganisers":
    "Організатори: Посольство України в Бельгії, UVRC та European Resolve.",
  "hero.participateHeading": "Як взяти участь",
  "hero.participateBody":
    "Обери рівень донату, потім зареєструйся та зроби свій внесок через варіанти нижче. Приєднуйся о 10:00 23 серпня на Place du Luxembourg. Не можеш бігти? Не проблема! Ти все одно можеш задонатити і залишити коментар «Підтримка здалеку».",
  "hero.updatesHeading": "Комунікація та оновлення",
  "hero.updatesBodyBefore":
    "Електронна пошта є нашим основним каналом комунікації. Регулярні анонси до дати події публікуватимуться на",
  "hero.updatesBodyAfter":
    ". Важливі анонси також надсилатимуться електронною поштою.",
  "hero.facebookEventLink": "сторінку події у Facebook",
  "hero.notesHeading": "Важливі примітки",
  "hero.notesBody":
    "Ми публікуватимемо всі звіти про зібрані кошти для прозорості на сторінці WhyDonate, тому залиш свою електронну адресу, щоб отримувати оновлення. Поділись цим збором з друзями, щоб максимізувати вплив!",
  "hero.closing": "Дякуємо за твою підтримку!",
  ...
  "register.stockWarningHeading": "Фізичні нагороди тимчасово закінчилися",
  "register.stockWarningBody":
    "Запас фізичних нагород (наклейки, шкарпетки, футболки та шарфи) наразі вичерпано. Ти все ще можеш зареєструватися та зробити донат. Нагороди будуть видані після прибуття нового замовлення. Щоб узгодити отримання, напиши на",
  ...
  "tierCard.rewards.marathoner":
    "Біг · Футболка · Стікерпак · Традиційний обід · 3 лотерейні квитки",
  ...
  "social.shareMessage":
    "Підтримай збір коштів {title} для Run for Ukraine! Кожне євро фінансує портативні електростанції для підрозділів ППО України.",
  ...
  "closed.deploymentUpdateHeading": "Оновлення щодо розгортання · 12 вересня 2026",
  "closed.deploymentUpdateLead":
    "Hurkit підтверджує, що всі кошти сплачені й закуплено вісім портативних електростанцій для трьох підрозділів-отримувачів. Доставка та звіти від підрозділів ще тривають.",
  "closed.deploymentUpdateBullet1":
    "Закуплено для 54-ї окремої механізованої бригади імені гетьмана Івана Мазепи: три Oukitel BP3000E (2048 Вт·год, 3200 Вт)",
  "closed.deploymentUpdateBullet2":
    "Закуплено для 13-ї оперативної бригади «Хартія»: одна EcoFlow DELTA 3 Max (2048 Вт·год, 2400 Вт) і дві EcoFlow Delta 2 (1024 Вт·год, 1800 Вт)",
