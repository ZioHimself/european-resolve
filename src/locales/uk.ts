...
export const uk = {
  ...
  "hero.scheduleIntro":
    "Відкрито для всіх. Йди, бігай або біжи у своєму темпі. Буде дві групи: початковий рівень, повільніший темп і коротша дистанція, та середній рівень, швидший темп і довша дистанція. Обидві групи фінішують разом на площі Beguinage.",
  ...
  "hero.updatesPublished": "Усі оновлення публікуватимуться на",
  "hero.updatesContact": "З питаннями або додатковою інформацією звертайся через",
