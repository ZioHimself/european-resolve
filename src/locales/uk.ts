...
export const uk = {
  ...
  "closed.deploymentUpdateLead":
    "Hurkit підтверджує, що всі кошти сплачені й закупівля триває для трьох підрозділів-отримувачів.",
  "closed.deploymentUpdateBullet1":
    "Три потужні портативні електростанції для 54-ї окремої механізованої бригади імені гетьмана Івана Мазепи",
  "closed.deploymentUpdateBullet2":
    "Одна потужна станція та дві одиниці EcoFlow для 13-ї оперативної бригади «Хартія»",
  "closed.deploymentUpdateBullet3":
    "Дві одиниці EcoFlow для 30-ї окремої механізованої бригади",
  ...
  "closed.deploymentUpdateBullet5":
    "Фото, відео та офіційні акти очікуються після завершення доставок",
