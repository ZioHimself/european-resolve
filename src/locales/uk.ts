...
export const uk = {
  ...
  "hero.title": "35 років Незалежності України: Благодійність і Забіг",
  "hero.description":
  ...
  "social.shareMessage":
    "Підтримай збір коштів {title} для 35 років Незалежності України: Благодійність і Забіг! Кожне євро фінансує зарядні станції для захисників і захисниць України.",
