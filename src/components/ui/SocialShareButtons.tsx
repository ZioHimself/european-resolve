...
export function SocialShareButtons({ url, title, message }: SocialShareButtonsProps) {
  ...
  const links = [
    ...
    },
    {
      ...
      href: `mailto:?subject=${encodeURIComponent(title + " | " + t("hero.title"))}&body=${encodeURIComponent(shareMessage + "\n\n" + url)}`,
      icon: (
